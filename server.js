...
// ---- Simple File-based Database (no external library) ----
const DB_FILE = path.join('/tmp', 'bookings_db.json');
...
app.get('/health', (req, res) => res.json({ status: 'ok', app: 'Jerry Event Organizers' }));
